...
class Image {
public:
    explicit Image(VkImage handle_, VkImageUsageFlags usage_, VkDevice owner_, VmaAllocator allocator_,
    ...
    Image(Image&& rhs) noexcept
        : handle{std::exchange(rhs.handle, nullptr)}, usage{rhs.usage}, owner{rhs.owner}, allocator{rhs.allocator},
